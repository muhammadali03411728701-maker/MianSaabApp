    ...
    <View style={styles.container}>
      ...
      {screen === 'home' ? (
        <ScrollView contentContainerStyle={styles.grid}>
          ...
          <TouchableOpacity style={styles.card} onPress={() => Alert.alert("Tri-Over", "Ready!")}><Text style={styles.icon}>🔥</Text><Text style={styles.cardT}>Tri-Super Over</Text></TouchableOpacity>
          ...
          <TouchableOpacity style={styles.card} onPress={() => Alert.alert("Backup", "Data Saved!")}><Text style={styles.icon}>☁️</Text><Text style={styles.cardT}>Backup JSON</Text></TouchableOpacity>
        </ScrollView>
      ) : (
        <View style={{flex: 1}}>
          ...
          {screen === 'entry' && (
            <ScrollView style={styles.padding}>
              ...
              <TouchableOpacity style={styles.saveBtn} onPress={() => Alert.alert("Success", "Team Registered!")}><Text style={{color:'white'}}>Register</Text></TouchableOpacity>
            </ScrollView>
          )}
        </View>
      )}
